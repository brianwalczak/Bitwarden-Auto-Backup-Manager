...
class SsoConfigApi extends base_response_1.BaseResponse {
    static fromView(view, api = new SsoConfigApi()) {
        ...
        else if (api.configType === sso_1.SsoType.Saml2) {
...
exports.SsoConfigApi = SsoConfigApi;
//# sourceMappingURL=sso-config.api.js.map