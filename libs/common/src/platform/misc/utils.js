...
class Utils {
    ...
    static getHostname(uriString) {
        ...
        try {
            const hostname = (0, tldts_1.getHostname)(uriString, { validHosts: this.validHosts });
            if (hostname != null) {
                return hostname;
            }
        }
    ...
    static getDomain(uriString) {
        ...
        try {
            const parseResult = (0, tldts_1.parse)(uriString, {
    ...
    static asyncToObservable(generator) {
        return (0, rxjs_1.of)(undefined).pipe((0, rxjs_1.switchMap)(() => generator()));
    }
    /**
...
exports.Utils = Utils;
Utils.inited = false;
Utils.isNode = true; // Brian: set to true
Utils.isBrowser = false; // Brian: set to false
