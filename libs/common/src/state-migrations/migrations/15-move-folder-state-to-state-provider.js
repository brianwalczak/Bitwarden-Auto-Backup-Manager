...
class FolderMigrator extends migrator_1.Migrator {
    migrate(helper) {
...
exports.FolderMigrator = FolderMigrator;
//# sourceMappingURL=15-move-folder-state-to-state-provider.js.map