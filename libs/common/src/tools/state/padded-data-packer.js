...
exports.PaddedDataPacker = void 0;
const utils_1 = require("../../platform/misc/utils");
const data_packer_abstraction_1 = require("./data-packer.abstraction");
 ...
 */
class PaddedDataPacker extends data_packer_abstraction_1.DataPacker {
    ...
    pack(value) {
        ...
        const b64 = utils_1.Utils.fromUtf8ToB64(json);
    ...
    unpack(secret) {
        ...
        const json = utils_1.Utils.fromB64ToUtf8(b64);
        const unpacked = JSON.parse(json);
        return unpacked;
    }
}
exports.PaddedDataPacker = PaddedDataPacker;
//# sourceMappingURL=padded-data-packer.js.map